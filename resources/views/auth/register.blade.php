                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nick" type="text" class="form-control @error('nick') is-invalid @enderror"
                                    name="nick" value="{{ old('nick') }}" required autocomplete="nick"
                                    autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input class="@error('avatar') is-invalid @enderror" id="avatar" type="file"
                                    name="avatar">
                                @error('avatar')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input class="@error('banner') is-invalid @enderror" id="banner" type="file"
                                    name="banner">
                                @error('banner')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
